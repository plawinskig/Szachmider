...
class MenuBackground():
    def __init__(self, screen_w, screen_h):
        ...
        self.bg_vignette = pygame.transform.scale(self.bg_vignette, (self.screen_w, screen_h))
        self.bg_vignette_rect = self.bg_vignette.get_rect(center=(self.screen_w / 2, screen_h / 2))
    ...
    def update(self, screen):
        i = 0
        while i < self.tiles:
            screen.blit(self.bg_img, (self.background_w * i + self.scroll, 0))
            i += 1
