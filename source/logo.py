...
class Logo():
    def __init__(self, pos):
        ...
        self.letter_bg_s = Button(pos=(self.x_pos - 217, self.y_pos),
        ...
        self.letter_bg_z = Button(pos=(self.x_pos - 172, self.y_pos + 12),
        ...
        self.letter_bg_a = Button(pos=(self.x_pos - 127, self.y_pos + 12),
        ...
        self.letter_bg_c = Button(pos=(self.x_pos - 83, self.y_pos + 12),
        ...
        self.letter_bg_h = Button(pos=(self.x_pos - 36, self.y_pos + 9),
        ...
        self.letter_bg_m = Button(pos=(self.x_pos + 27, self.y_pos + 9),
        ...
        self.letter_bg_i = Button(pos=(self.x_pos + 86, self.y_pos),
        ...
        self.letter_bg_d = Button(pos=(self.x_pos + 136, self.y_pos),
        ...
        self.letter_bg_e = Button(pos=(self.x_pos + 180, self.y_pos + 9),
        ...
        self.letter_bg_r = Button(pos=(self.x_pos + 223, self.y_pos + 12),
        ...
        self.letter_front_s = Button(pos=(self.x_pos - 217, self.y_pos),
        ...
        self.letter_front_z = Button(pos=(self.x_pos - 172, self.y_pos + 12),
        ...
        self.letter_front_a = Button(pos=(self.x_pos - 127, self.y_pos + 12),
        ...
        self.letter_front_c = Button(pos=(self.x_pos - 83, self.y_pos + 12),
        ...
        self.letter_front_h = Button(pos=(self.x_pos - 36, self.y_pos + 9),
        ...
        self.letter_front_m = Button(pos=(self.x_pos + 27, self.y_pos + 9),
        ...
        self.letter_front_i = Button(pos=(self.x_pos + 86, self.y_pos),
        ...
        self.letter_front_d = Button(pos=(self.x_pos + 136, self.y_pos),
        ...
        self.letter_front_e = Button(pos=(self.x_pos + 180, self.y_pos + 9),
        ...
        self.letter_front_r = Button(pos=(self.x_pos + 223, self.y_pos + 12),
