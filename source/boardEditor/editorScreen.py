...
class EditorScreen:
    def __init__(self, position, screenWidth, screenHeight):
        ...
        self.saveButton = Button(pos=(screenWidth-200, 70), text="Zapisz i wyjdź", imgNormal=pygame.image.load("assets/buttons/BTN_play.png").convert_alpha(),
        ...
        self.squareSelector = SquareSelector(screenWidth//2, screenHeight-80, r=3)
        self.pieceSelector = PieceSelector(screenWidth//2, screenHeight-200)
